...
export class GenerateMessageService {
  private readonly generateMessageSchema = z.object({
    type: z
    ...
    sender_name: z
      ...
      .optional()
      .describe(
        'Name of the person/user sending the message (defaults to user_name from state)',
      ),
    context: z
      .string()
      ...
      .optional()
      .describe(
        'Details about the lead, their company, pain points, or why we are reaching out',
      ),
  });
